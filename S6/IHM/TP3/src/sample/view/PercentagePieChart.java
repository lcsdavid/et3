...
public class PercentagePieChart  extends Canvas implements TODO {
	...
	/**
	 * Hold a reference to the sample.model
	 */
	...
	public PercentagePieChart(Percentage_Controller controller) {
        ...
        //Add the sample.event handler of the mouse
...
// for "sample.controller" behaviour
	/**
	 * Test if a mouse sample.event is inside the "Pin" that allows
