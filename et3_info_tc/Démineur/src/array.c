...
int search_couple_in_array_int(int **array, int value1, int value2, size_t size) {
    for (size_t i = 0; i < size; i++)
...
int **loto_2(int min_1, int max_1, int min_2, int max_2, size_t nb_draw) {
    int **draw = malloc(sizeof(int *) * nb_draw);
    for (size_t i = 0; i < nb_draw; i++) {
        draw[i] = malloc(sizeof(int) * nb_draw);
        do {
            int random_number_1 = my_rand(min_1, max_1);
            int random_number_2 = my_rand(min_2, max_2);
            if (search_couple_in_array_int(draw, random_number_1, random_number_2, i) == 0) {
                draw[i][0] = random_number_1;
                draw[i][1] = random_number_2;
                break;
            }
        } while (1);
    }
